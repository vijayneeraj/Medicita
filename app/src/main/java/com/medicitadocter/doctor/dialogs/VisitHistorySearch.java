...
public class VisitHistorySearch extends Dialog implements View.OnClickListener {

    private Context context;
    private ImageView ivCancel;

    public VisitHistorySearch(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View layout = inflate.inflate(R.layout.doc_visit_history_search, null);
