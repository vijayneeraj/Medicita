...
public class PrescriptionsDilaog extends Dialog implements View.OnClickListener {

    private Context context;
    private ImageView ivCancel;

    public PrescriptionsDilaog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View layout = inflate.inflate(R.layout.doc_prescriptions, null);
